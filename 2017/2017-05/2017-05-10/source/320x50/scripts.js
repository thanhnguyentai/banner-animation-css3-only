...
introAnim = function() {
  ...
  var tl = new TimelineLite();
    ...
    tl.to('#bar1', 0, {backgroundPosition: 'top right', right: 152, left: 'auto'});
    tl.to('#bar2', 0, {backgroundPosition: 'top right', right: 152, left: 'auto'});
    tl.to('#bar3', 0, {backgroundPosition: 'top right', right: 152, left: 'auto'});
