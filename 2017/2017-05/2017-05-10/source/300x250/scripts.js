...
introAnim = function() {
  ...
  var tl = new TimelineLite();
    ...
    tl.to('#star1', 1.5, {left:493});
    tl.to('#bar1', 0.35, {width:250}, '-=1.25');
    tl.to('#star2', 1.5, {left:493}, '-=1');
    tl.to('#bar2', 0.35, {width:250}, '-=1.25');
    tl.to('#star3', 1.5, {left:493}, '-=1');
    tl.to('#bar3', 0.35, {width:250}, '-=1.25');

     // Fading Out Animation assets

    tl.to('#star1', 1, {opacity:0}, '+=1');
    ...
    tl.to('#star1', 0.1, {left:-300});
    tl.to('#bar1', 0.1, {left:-300}, '-=0.1');
    tl.to('#star2', 0.1, {left:-300}, '-=0.1');
    tl.to('#bar2', 0.1, {left:-300}, '-=0.1');
    tl.to('#star3', 0.1, {left:-300}, '-=0.1');
    tl.to('#bar3', 0.1, {left:-300}, '-=0.1');
    tl.to('#animation', 0.1, {left:-300}, '-=0.1');
